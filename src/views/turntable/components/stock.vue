<template>
    <div class="qike-main text-left stock">
        ...
        <template v-else>
            ...
            <h5 class="flex items-center text-right">
                <span>贵神：</span>
                <div class="w-6">{{guishenGanResult.name}} | {{ guishenResult.name }}</div>
            ...
            <h5 class="flex items-center text-right pt-2">
                <fieldset>
                    <legend>纳音</legend>
                    <h5 class="flex items-center text-right">
                        <div class="w-8">{{ guishenGanResult.nayin }}</div>
                        <div class="w-8">{{ guishenGanResult.nayinResult }}</div>
                        <div class="w-8">{{ guishenGanResult.shengke }}</div>
                    </h5>
                    <h5 class="flex items-center text-right">
                        <div class="w-8">{{ shenjiangGanResult.nayin }}</div>
                        <div class="w-8">{{ shenjiangGanResult.nayinResult }}</div>
